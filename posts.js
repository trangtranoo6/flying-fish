const SITE = {
  ...
  about: `
    ...
    from characters who exist only in my head. I have just started this page recently in summer 2026, but I have been writing since long ago (in Vietnamese language), so I will keep updating my page with old notes when I am not too lazy to type and translate (I am bad at translating though).</p>
